...
<head>
    ...
    <link rel="icon" href="{{ asset('/images/logo/kopcus.png') }}" />
                ...
                <ul class="dropdown-menu dropdown-user animated fadeIn">
                    <div class="dropdown-user-scroll scrollbar-outer">
                        <li>
                            <div class="user-box">
                                <div class="avatar-lg"><img
                                        src="{{ asset('/img/profile_user/' . AUTH::user()->image) }}"
                        ...
                        <li>
                            ...
                            <a class="dropdown-item" href="{{ url('user') }}"><i class="fas fa-user-tie mr-3"></i>
                                My
                                Profile</a>
                            <a class="dropdown-item" href="{{ url('password') }}"><i
                                    class="fas fa-user-tag mr-3"></i>
                                Change Password</a>
                                ...
                                <form action="{{ url('user') }}/{{ $user->id }}" method="POST">
                                    ...
                                    <div class="selectgroup selectgroup-secondary selectgroup-pills">
                                        ...
                                        <label class="selectgroup-item mt-2">
                                            <input type="radio" name="mode" value="2" class="selectgroup-input"
                                                @if ($user->mode_gelap == 2)
                                            checked=""
                                        ...
                                        <label class="selectgroup-item mt-2">
                                            <input type="radio" name="mode" value="1" class="selectgroup-input"
                                                onclick="submit()" @if ($user->mode_gelap == 1)
                                            checked=""
                                            @endif>
                                            <span class="selectgroup-button selectgroup-button-icon"><i
